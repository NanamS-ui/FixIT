...
<head>
    ...
    <link rel="icon" type="image/png" href="<%= request.getContextPath()%>/temp/front_Office/images/logo.png">
...
<section id="cars">
    ...
    <div class="images">
        <ul>
            <li class="car">
                <div>
                    <img src="<%= request.getContextPath()%>/temp/front_Office/images/car1.jpg" alt="">
                </div>
            ...
            <li class="car">
                <div>
                    <img src="<%= request.getContextPath()%>/temp/front_Office/images/car2.jpg" alt="">
                </div>
                <span>LAMBORGHINI</span>
                <span class="prix">300.000$</span>
            </li>
            <li class="car">
                <div>
                    <img src="<%= request.getContextPath()%>/temp/front_Office/images/car3.jpg" alt="">
                </div>
                <span>LAMBORGHINI</span>
                <span class="prix">300.000$</span>
            </li>
            <li class="car">
                <div>
                    <img src="<%= request.getContextPath()%>/temp/front_Office/images/car4.jpg" alt="">
                </div>
                <span>LAMBORGHINI</span>
                <span class="prix">300.000$</span>
            ...
            <li class="car">
                <div>
                    <img src="<%= request.getContextPath()%>/temp/front_Office/images/car5.jpg" alt="">
                </div>
                <span>LAMBORGHINI</span>
                <span class="prix">300.000$</span>
                <a href="#">ACHETER MAINTENANT</a>
            ...
            <li class="car">
                <div>
                    <img src="<%= request.getContextPath()%>/temp/front_Office/images/car6.jpg" alt="">
                </div>
                <span>LAMBORGHINI</span>
                <span class="prix">300.000$</span>
                <a href="#">ACHETER MAINTENANT</a>
